 ...
 * @author Jaret
 */
public class FrmGraficaPastel extends javax.swing.JFrame implements ControladorBrokerListener {

    /**
     * Creates new form FrmGrafica
     */
    private Grafica graficaPastel = null;
    ...
    public FrmGraficaPastel(ControladorBroker ctrlBroker) {
        ...
        graficaPastel = new GraficaPastel("Resultados (Gráfico de pastel)");
        add(graficaPastel.getPanel(), BorderLayout.CENTER);
    ...
    public void onCambioVotos(List<ProductoDTO> productos) {
        ...
        graficaPastel.setDatos(etiquetas, valores);
